...
par(mfrow=c(2,2))
imagep(levitus$longitude, levitus$latitude, levitus$SST, zlab="SST [degC]", zlim=quantile(levitus$SST, c(0.025, 0.975), na.rm=TRUE))
lines(coastlineWorld[["longitude"]], coastlineWorld[["latitude"]], lwd=1/2, col="gray") 
imagep(levitus$longitude, levitus$latitude, levitus$SSS, zlab="SSS [PSU]", zlim=quantile(levitus$SSS, c(0.025, 0.975), na.rm=TRUE))
lines(coastlineWorld[["longitude"]], coastlineWorld[["latitude"]], lwd=1/2, col="gray") 
imagep(levitus$longitude, levitus$latitude, levitus$SSO, zlab="SSO [ml/l]", zlim=quantile(levitus$SSO, c(0.025, 0.975), na.rm=TRUE))
lines(coastlineWorld[["longitude"]], coastlineWorld[["latitude"]], lwd=1/2, col="gray") 
